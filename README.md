...
- I got this problem on the Leetcode mock OA. It's hard to believe I could come out the greedy algorithm to solve this problem within the time limit. But the most difficult part is to prove its correctness. In general, this kind of problem are usually fall into DP category.
